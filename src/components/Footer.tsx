    ...
    <footer className="bg-gray-100 dark:bg-[#040506] text-gray-700 dark:text-gray-300 py-8">
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-between">
          ...
          <div className="w-full sm:w-1/2 md:w-1/4 mb-6">
            ...
            <p className="pr-4">
              A web developer, who loves creating web application that users
              love.
            </p>
          </div>
          ...
          <div className="w-full sm:w-1/2 md:w-1/4 mb-6">
            ...
            <p>Feel free to get in touch with me via email:</p>
            <Link
              href="mailto:devmaungshine@gmail.com"
      ...
      <div className="border-t border-gray-200 dark:border-gray-700 mt-8 pt-4">
        <div className="container mx-auto text-center text-sm text-gray-500 dark:text-gray-400">
          &copy; {new Date().getFullYear()}. All rights reserved By MAUNG SHINE.
        </div>
      </div>
    </footer>
  );
