...
const Presentation = ({
  ...
  return (
    <article className="flex justify-center h-[80vh] gap-4 dark:bg-default-50 border border-default-100 rounded-md p-2 md:p-12 pt-12 bg-white/80 backdrop-blur-sm overflow-y-scroll w-[100vw] md:w-[80vw]">
